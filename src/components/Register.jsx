         ...
         <div className="absolute top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4 || w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
            <form onSubmit={handleSubmit(submit)} className="space-y-6" action="#">
               ...
               <div className="relative">
                  ...
                  <input type="name" {...register("name", { required: true })} placeholder="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" />
